...
const isSignedIn = inject("is-signed-in");
</script>
    ...
    >
      ...
      <div v-if="!isSignedIn" class="w-full max-w-5xl h-fit">
        ...
        >
          ...
          <div
            class="flex items-center justify-between w-full h-14 sm:h-16 min-w-80 rounded-full border-2 border-stone-400 px-5 sm:px-7"
          >
            <input
              type="text"
              placeholder="이 코드의 약점을 분석해줘"
              class="full-width-input w-full h-fit bg-transparent text-base placeholder:text-stone-400 focus:outline-none"
              disabled
            />
