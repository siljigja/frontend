...
<template>
  <div class="flex flex-col justify-evenly items-center gap-64">
    <Navbar />
    <main class="flex justify-center items-center h-full">
      <p class="flex flex-col items-center text-base gap-8">
        <svg
          class="size-24 fill-stone-500"
          viewBox="0 0 24 24"
          fill="none"
        ...
        <span class="text-xl text-stone-400">404 NOT FOUND</span>
        존재하지 않는 페이지 입니다.
        <button @click="goBack" class="underline hover:cursor-pointer">
          돌아가기
        </button>
      </p>
    </main>
